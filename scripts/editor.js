$(document).ready(function () {
    ...
    menubar.find('.menuSaveAs').click(function () {
        ...
        bootbox.prompt(bbCaption, function (result) {
            if ( result !== null ) {
                ...
                //Save the file
                saveFile(title, filename, mode, redirect, includeDisqus, wysiwygOn, watchedOutline, lockedOutline, opOutlineToXml(ownerName, ownerEmail));
            }
        });
    ...
    menubar.find('.menuSaveArticle').click(function () {
        ...
        if(lockedOutline && wasLocked) {
            ...
            saveFile(title, filename, mode, redirect, includeDisqus, wysiwygOn, watchedOutline, lockedOutline, opOutlineToXml(ownerName, ownerEmail), undefined, true);
        }
        $('#dropdownSave').dropdown('hide');
        return false;
    });
...
//        }
    ...
    //Save a file
    function saveFile(ftitle, fname, fmode, fredirect, fdisqus, fwysiwyg, fwatched, flocked, fopml, foldname, asarticle) {
