        ...
        <form id="frmArticleGetRange" name="rangeget" method="GET" action="<? echo $_SERVER['PHP_SELF'] ?>">
            <fieldset>
                ...
                <div style="float:left;clear:both;">
                    ...
                    <a id="aOpmlExport" href="<? echo $s3cartopml ?>" label="OPML"><img class="icon-opml" alt=""
                                                                                        src="/images/blank.gif"/></a>
                    <? if (!empty($g_prefs['imap_server'])) { ?><a id="aEmailImport" style="color:black;" href="#" label="EMAIL"><i
