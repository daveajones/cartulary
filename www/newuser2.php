...
<div class="row" id="divNewUser2">
    ...
    <p><em>Now, do you have any OPML subscription lists you want to bring in? If not, just hit skip and we'll bring in some default feeds for you to get your river started.</em></p>
        ...
        <fieldset>
            <div class="control-group">
                ...
                <div id="divSubscribeButtons">
                    ...
                    <input id="btnSubscribe" name="submitSubscribe" class="btn btn-primary btnSubmit" type="submit"
                           value="Subscribe"/>
                    <? if ($platform != "mobile" && $platform != "tablet") { ?>
                        or <input id="btnFileShow" name="submitImport" class="btn btn-primary btnSubmit" type="button"
                                  value="Import..."/>
                    <? } ?>
                </div>
            </div>
    ...
    <form id="frmSkip" name="skip" action="/cgi/auth/setup2" method="POST">
        <input name="url" type="hidden" value="<? echo $cg_default_subscription_list_url ?>"/>

        <div id="divSkip" class="pull-right"><span class="message"></span>
            <button id="btnPrefSubmit" class="btn btn-primary" type="submit">Skip</button>
        </div>
    </form>
