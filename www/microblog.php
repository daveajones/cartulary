...
if (s3_is_enabled($uid) || sys_s3_is_enabled()) {
    ...
    $s3blogfeed = $system_url . "/" . $microblogpage . "-external?uid=$uid&feed=blog";
    $s3microblogfeed = $system_url . "/" . $microblogpage . "-external?uid=$uid";
    $s3blogopml = $system_url . "/" . $microblogpage . "-external?uid=$uid&type=opml";
    $s3bloghtml = $system_url . "/" . $microblogpage . "-external?uid=$uid&type=html";
}
