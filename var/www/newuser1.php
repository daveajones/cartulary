...
<div class="row" id="divNewUser1">
	...
	<p><em>If you have an Amazon S3 account, put the credentials here.  If not, you can just leave all this blank and you'll be assigned a
        ...
        <div id="divPrefSubmit" class="pull-right"><span class="message"></span><button id="btnPrefSubmit" class="btn btn-primary" type="submit">Next</button></div>
