...
<div class="row" id="divFeedFinder">
    ...
    <ul class="unstyled"><?
        foreach ($feedlocs as $feedloc) {
            ...
            <form id="frmFeedFinderSubscribe" class="feedFinderForm" name="subscribe" action="<? echo $subscribecgi ?>"
                  method="POST">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div id="divSubscribeButtons">
                            ...
                            ?>
                            <h3><input id="btnSubscribe" name="submitSubscribe"
                                       class="btn <? echo $btnclass ?> btnSubmit" type="submit" value="Subscribe"/> to [<a
                                    href="<? echo trim($url) ?>"><? echo htmlspecialchars($linkdesc) ?></a>] -
                                <span><? echo $btndesc ?></span>
                            </h3>
                        </div>
                    </div>
                </fieldset>
